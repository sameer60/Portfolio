      ...
      <div className="features-bottom-section">
        <div className="test">
          ...
          <div className="feature-card">
            ...
            <p className="feature-card-description">
              The world has gone mobile - so why not your website? I specialize
              in responsive web design so you never have to worry about your
              content being seen by customers or users no matter what device
              they're on.
            </p>
          </div>
        </div>
        <div className="test">
          ...
          <div className="feature-card">
            ...
            <p className="feature-card-description">
              I focus on making sure code runs smoothly and efficiently, so you
              can focus on other parts of running your business. Simpler code
              means less maintenance and lower chances of bugs - always a win!
            </p>
          </div>
        </div>
        <div className="test">
          ...
          <div className="feature-card">
            ...
            <p className="feature-card-description">
              I keep myself up-to-date on the newest tools and technologies like
              ReactJS, NextJS or Tailwind CSS (just to name a few). I Choose
              best tools for the task at hand to implement them in the most
              effective way.
            </p>
          </div>
        </div>
